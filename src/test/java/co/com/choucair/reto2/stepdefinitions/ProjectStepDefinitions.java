...
import co.com.choucair.reto2.questions.ResultData;
...
public class ProjectStepDefinitions {
   ...
   // public void validarCostosFijos(String n1) throws Exception {
        // Write code here that turns the phrase above into concrete actions
     //   OnStage.theActorInTheSpotlight().should(GivenWhenThen.seeThat(ResultData.toThe(n1)));
    //}
    ...
    @Then("^Validar costos fijos$")
    public void validacionDeCostosFijos(List<Data_result> datosLeasing) throws Exception {
        // Write code here that turns the phrase above into concrete actions
        OnStage.theActorInTheSpotlight().should(GivenWhenThen.seeThat(ResultData.toThe(datosLeasing)));
    }
